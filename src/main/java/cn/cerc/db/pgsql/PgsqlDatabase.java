...
public class PgsqlDatabase implements IHandle, ISqlDatabase {
    ...
    public PgsqlDatabase(IHandle handle, Class<? extends EntityImpl> clazz) {
        super();
        this.clazz = clazz;
    ...
    public boolean createTable(boolean overwrite) {
        PgsqlServer server = (PgsqlServer) this.getSession().getProperty(PgsqlServer.SessionId);
    ...
    public boolean createEntityClass(String table) {
        ...
        PgsqlQuery ds = new PgsqlQuery(this);
        ...
        while (ds.fetch()) {
            ...
            try {
                ...
                // 获取列
                PgsqlQuery cdsTmp = new PgsqlQuery(this);
