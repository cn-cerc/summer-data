...
//        this.files.clear();
//        this.subItems.clear();
//        IOssAction client = disk.getClient();
//
//        String marker = "";
//        while (true) {
//            // 构造ListObjectsRequest请求
//            ListObjectsRequest params = new ListObjectsRequest(disk.getConnection().getClient().getBucket());
//
//            // 设置参数
//            params.setDelimiter("/");
...
//
//            // List Objects
//            ObjectListing listing = client.listFiles(params);
//
//            // 遍历所有Object
//            // log.info("Objects:");
